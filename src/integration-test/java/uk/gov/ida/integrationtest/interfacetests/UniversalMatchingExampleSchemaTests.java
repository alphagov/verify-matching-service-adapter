...
public class UniversalMatchingExampleSchemaTests extends BaseTestToolInterfaceTest {
    private static final String REQUEST_ID = "default-match-id";
    private static final String PID = "default-pid";

    @ClassRule
    public static final DropwizardAppRule<MatchingServiceAdapterConfiguration> appRule = new MatchingServiceAdapterAppRule(false, universalConfigRules);
    ...
    public void shouldProduceLoA2SimpleCase() throws Exception {
        ...
        Path path = Paths.get("verify-matching-service-test-tool/src/main/resources/universal-dataset/LoA2-Minimum_data_set.json");
    ...
    public void shouldProduceLoA1SimpleCase() throws Exception {
        ...
        Path path = Paths.get("verify-matching-service-test-tool/src/main/resources/universal-dataset/LoA1-Minimum_data_set.json");
    ...
    public void shouldProduceLoA1ExtensiveCase() throws Exception {
        ...
        Path path = Paths.get("verify-matching-service-test-tool/src/main/resources/universal-dataset/LoA1-Extended_data_set.json");
    ...
    public void shouldProduceLoA2ExtensiveCase() throws Exception {
        ...
        Path path = Paths.get("verify-matching-service-test-tool/src/main/resources/universal-dataset/LoA2-Extended_data_set.json");
    ...
    public void shouldProduceUserAccountCreationJson() throws Exception {
        ...
        Path filePath = Paths.get("verify-matching-service-test-tool/src/main/resources/universal-dataset/user_account_creation.json");
