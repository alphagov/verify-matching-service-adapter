...
public class DefaultIdentityProviderTrustStoreConfiguration extends TrustStoreConfiguration {
    /**
    ...
    public DefaultIdentityProviderTrustStoreConfiguration(MatchingServiceAdapterEnvironment environment) {
    ...
    public KeyStore getTrustStore() {
        ...
        switch (environment) {
            case PRODUCTION:
                trustStoreName = PRODUCTION_IDP_TRUSTSTORE_NAME;
                break;
            case INTEGRATION:
                trustStoreName = INTEGRATION_IDP_TRUSTSTORE_NAME;
                break;
            default:
