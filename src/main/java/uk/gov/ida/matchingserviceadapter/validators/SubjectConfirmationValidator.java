...
public class SubjectConfirmationValidator<T> extends CompositeValidator<T> {
    ...
    public SubjectConfirmationValidator(Function<T, SubjectConfirmation> valueProvider, DateTimeComparator dateTimeComparator, String hubConnectorEntityId) {
        super(
            true,
            valueProvider,
            ...
            new SubjectConfirmationDataValidator<>(SubjectConfirmation::getSubjectConfirmationData, dateTimeComparator, hubConnectorEntityId)
        );
    }
