...
public class SubjectValidator<T> extends CompositeValidator<T> {
    ...
    public SubjectValidator(Function<T, Subject> valueProvider, TimeRestrictionValidator timeRestrictionValidator) {
        super(
            true,
            valueProvider,
            ...
            new SubjectConfirmationValidator<>(subject -> subject.getSubjectConfirmations().get(0), timeRestrictionValidator)
        );
    }
